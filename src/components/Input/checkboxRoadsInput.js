...
import { taxonomyRoadsOptions } from '@data/fusa_taxonomy'
...
const TagsDialog = ({
  ...
  return (
    ...
    >
      <DialogTitle>
        {'Seleccione los tipos de vehículos existentes en el audio/video:'}
      </DialogTitle>
      <DialogContent>
        {taxonomyRoadsOptions.map((type, i) => {
          return (
            <TypeContainer key={i}>
...
const CheckboxRoadsInput = ({ label, ...props }) => {
...
export default CheckboxRoadsInput
